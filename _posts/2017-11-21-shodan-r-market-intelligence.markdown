...
PS. I have noticed that some queries fail to return results via the shodan package, although they work fine using the Web Interface. This is likely due to problems in the package,
